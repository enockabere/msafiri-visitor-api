...
class UserRole(BaseModel):
    ...
    role = Column(ENUM('SUPER_ADMIN', 'MT_ADMIN', 'HR_ADMIN', 'EVENT_ADMIN', 'FINANCE_ADMIN', 'VETTING_COMMITTEE', 'VETTING_APPROVER', 'PER_DIEM_APPROVER', 'VOUCHER_SCANNER', 'VISITOR', 'GUEST', 'STAFF', 'USER', name='roletype', create_type=False), nullable=False, index=True)
