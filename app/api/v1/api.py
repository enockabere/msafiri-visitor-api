...
api_router.include_router(
    password_reset_otp.router,
    prefix="/auth",
    tags=["password-reset-otp"]
)

api_router.include_router(
    account_creation.router,
    prefix="/auth",
...
# Cash Claims AI Chat (separate prefix to avoid /{claim_id} conflict)
api_router.include_router(
    claim_chat.router,
    prefix="/claim-chat",
...
# Vetting chat (group chat for vetting committee discussions)
api_router.include_router(
    vetting_chat.router,
    prefix="",
    tags=["vetting-chat"]
...
# Travel Request Approvals (workflow)
from app.api.v1.endpoints import travel_request_approvals
api_router.include_router(
    travel_request_approvals.router,
    prefix="/travel-requests",
