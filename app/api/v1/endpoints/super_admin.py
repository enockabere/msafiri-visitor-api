...
def invite_super_admin(
    *,
    ...
    if not user_existed:
        ...
        # Set password for admin portal access while keeping SSO for mobile
        # Note: auth_provider stays as is (e.g., MICROSOFT_SSO) to preserve SSO login
        ...
        needs_password = True
        logger.info(f"Set password for admin portal access for {existing_user.email} (auth_provider: {existing_user.auth_provider})")
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); overflow: hidden;">
                            ...
                            <tr>
                                <td style="padding: 40px 30px;">
                                    ...
                                    {get_user_info_section(user_existed, email, default_password)}
                                    ...
                                    {get_first_login_steps(user_existed)}
