...
def create_direct_messages_table():
    """Create the missing direct_messages table on production"""
    ...
    try:
        ...
        print("SUCCESS: direct_messages table created successfully on production")
        return True
...
if __name__ == "__main__":
    print("Creating direct_messages table on production...")
