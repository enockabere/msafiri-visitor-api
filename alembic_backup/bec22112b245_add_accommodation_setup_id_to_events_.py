"""Add accommodation_setup_id to events table

Revision ID: bec22112b245
Revises: 86bb3be9b7e0
Create Date: 2025-10-23 12:09:26.428310
...
revision = 'bec22112b245'
down_revision = '86bb3be9b7e0'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.add_column('guesthouses', sa.Column('facilities', sa.TEXT(), autoincrement=False, nullable=True))
    op.add_column('guesthouses', sa.Column('contact_phone', sa.VARCHAR(length=20), autoincrement=False, nullable=True))
    op.add_column('guesthouses', sa.Column('contact_person', sa.VARCHAR(), autoincrement=False, nullable=False))
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('event_travel_requirements_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('event_id', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='event_travel_requirements_event_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='event_travel_requirements_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('event_welcome_packages_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('event_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('item_name', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name='event_welcome_packages_event_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='event_welcome_packages_pkey'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('public_registrations_event_id_fkey'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['participant_id'], ['event_participants.id'], name=op.f('public_registrations_participant_id_fkey'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('public_registrations_pkey'))
    )
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_item_id'], ['event_items.id'], name=op.f('participant_allocations_event_item_id_fkey')),
    sa.ForeignKeyConstraint(['participant_id'], ['event_participants.id'], name=op.f('participant_allocations_participant_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('participant_allocations_pkey')),
    sa.UniqueConstraint('event_item_id', 'participant_id', name=op.f('participant_allocations_event_item_id_participant_id_key'), postgresql_include=[], postgresql_nulls_not_distinct=False)
    )
    ...
    sa.Column('created_by', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('chat_rooms_event_id_fkey')),
